...
- The `r pkg("mbg")` package offers [convenience functions](https://henryspatialanalysis.github.io/mbg/articles/spatial-ml-models.html) for fitting `r pkg("caret")` models with point-referenced outcomes and raster features.
